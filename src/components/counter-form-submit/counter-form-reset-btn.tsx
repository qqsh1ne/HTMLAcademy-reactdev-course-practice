interface CounterFormResetBtnProps {
    title: string
    reset: () => void
    disabled?: boolean
}

const CounterFormResetBtn = ({ title, reset,  ...attrs }: CounterFormResetBtnProps) => {
    return (
        <button className="form__reset-button" name="reset" type="reset" onClick={reset} {...attrs}>
...
export default CounterFormResetBtn;
